...
1. Click the **+** icon in the top-right → **New repository**.  
   ![Figure 10: Creating a new repository in GitHub.](images/creating-a-new-repository-in-GitHub.png) *Figure 10: Creating a new repository in GitHub.*

2. Enter a repository name (e.g., `my-first-repo`) and description.  
...
4. Select **Add a README file** → Click **Create repository**.  
...
git clone [https://github.com/username/my-first-repo.git](https://github.com/username/my-first-repo.git)
cd my-first-repo
...
4. After a successful commit, the repository updates to show the new file and commit message.  
...
![Figure: Diagram of the Git workflow — working directory → staging area → repository.](images/git_workflow.png)
*Figure: Diagram of the Git workflow — working directory → staging area → repository.*  

![Figure: Diagram of GitHub collaboration workflow — push, pull, fork, and merge requests.](images/github_collaboration.png)
*Figure: Diagram of GitHub collaboration workflow — push, pull, fork, and merge requests.*
